...
import { Settings, Search, Filter, Download } from "lucide-react";
import { AMCTable } from "@/components/dashboard/AMCTable";
  ...
  return (
    <div className="flex flex-col gap-6 max-w-[1600px] mx-auto pb-10 h-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">AMC Management</h1>
          <p className="text-sm font-medium text-slate-500 mt-1">Track Annual Maintenance Contracts, renewals, and expirations.</p>
        </div>
      ...
      <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="relative w-full sm:max-w-md">
          ...
          <input 
            type="text" 
            placeholder="Search by customer, plan, or contract ID..." 
